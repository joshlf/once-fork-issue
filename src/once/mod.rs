...
impl Once {
    ...
    pub const fn new() -> Once {
        Once {
            ...
            // Though it would be nice to initialize this to the process' UPID so that calls to
            // call_inner could avoid an unnecessary CAS, that would make this function
            // non-constant. Besides, the vast majority of programs will never fork without
            // exec'ing, and since the default UPID is 0, in most programs, this will be the
            // correct UPID 100% of the time.
            upid: AtomicUsize::new(0),
